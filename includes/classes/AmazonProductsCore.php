        ...
        foreach($xml->children() as $x){
            ...
            if (isset($x->Products)){
                foreach($x->Products->children() as $z){
                    $this->productList[$this->index] = (new AmazonProduct($this->storeName, $z, $this->mockMode, $this->mockFiles,$this->config))->getData();
                ...
                $this->productList[$this->index] = (new AmazonProduct($this->storeName, $x, $this->mockMode, $this->mockFiles,$this->config))->getData();
                $this->index++;
            } else {
